var search = require('./tweets-search')
  , user = require('./tweets-user')
  , home = require('./tweets-home')
  , mentions = require('./tweets-mentions')

module.exports = function (api) {
  if (api.options.q) api = search(api);
  else if (api.options.user_id || api.options.screen_name) api = user(api);
  else if (api.options.mentions) api = mentions(api)
  else api = home(api);
